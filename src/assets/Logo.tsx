    ...
    <svg version="1.1" width="60" height="60" viewBox="0 0 256 256">
      ...
      <g transform="translate(128 128) scale(0.72 0.72)">
        ...
        >
          ...
          />
          <path
            d="M 79.113 10.97 h -2.936 V 8.034 c 0 -1.104 -0.896 -2 -2 -2 s -2 0.896 -2 2 v 2.936 h -2.936 c -1.104 0 -2 0.896 -2 2 s 0.896 2 2 2 h 2.936 v 2.936 c 0 1.104 0.896 2 2 2 s 2 -0.896 2 -2 V 14.97 h 2.936 c 1.104 0 2 -0.896 2 -2 S 80.218 10.97 79.113 10.97 z"
            style={{
              stroke: 'none',
              strokeWidth: 1,
              strokeDasharray: 'none',
